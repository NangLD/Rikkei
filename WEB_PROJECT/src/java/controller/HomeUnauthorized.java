 ...
 * @author Admin
 */
@WebServlet(name = "HomeUnauthorized", urlPatterns = {"/HomeUnauthorized"})
public class HomeUnauthorized extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (logInObject != null && passObject!= null) {
            ...
            int id= accDao.getId((String) logInObject, (String) passObject);
            response.sendRedirect("home?ID=" + id);
            return;
        }
        request.getRequestDispatcher("/home_unauthorized.jsp").forward(request, response);
