 ...
 * @author Admin
 */
@WebServlet(name = "QestionServlet", urlPatterns = {"/QestionServlet"})
public class QestionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        QuestionDAO qesDao = new QuestionDAO();
        List<Question> questions = qesDao.getByUserId(Integer.parseInt(id));
        request.setAttribute("questions", questions);
        TitleDAO titleDao = new TitleDAO();
        List<Title> titles = titleDao.getByUserId(Integer.parseInt(id));
        request.setAttribute("titles", titles);
        request.getRequestDispatcher("/home_question.jsp").forward(request, response);
    }
